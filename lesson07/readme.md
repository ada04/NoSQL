...
Подводя итоги можно сказать, что Couchbase имеет довольно хорошую отказоустойчисвость и понятный интерфейс. Можно легко дообавлять и убирать узлы кластера не теряя при этом данные.
