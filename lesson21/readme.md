...
create (geo:country {name: 'Georgia'})
...
create (msk) -[:ton {type: 'land', by: 'auto'}]-> (gud)
...
```
Created 33 nodes, created 49 relationships, set 88 properties, added 32 labels
